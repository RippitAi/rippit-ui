    ...
    >
      <div className="flex items-center gap-3.5">
        ...
        <div className="flex items-center gap-1.5">
          <div className="size-[7px] rounded-[2px] bg-ok" />
          <div className="tabular text-[10.5px] text-t2">1,272 ok</div>
        </div>
        <div className="flex items-center gap-1.5">
          <div className="size-[7px] rounded-[2px] bg-err" />
        ...
        {buckets.map((b, i) => (
          ...
          >
            <div
              ...
              style={{ height: b.g, background: "rgba(34,197,94,.55)" }}
            />
            {b.r > 0 && (
              <div
                className="rounded-[2px]"
                style={{ height: b.r, background: "rgba(239,68,68,.9)" }}
              />
            )}
          </div>
        ))}
        <div className="h-full w-[2px] rounded-[2px] bg-t1" />
      </div>
